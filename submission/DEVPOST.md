...
- Live project: [LAST WORDS](https://lastwords-eznzihexpa-du.a.run.app/)
...
1. Open [the live project](https://lastwords-eznzihexpa-du.a.run.app/) in two browser windows.
...
7. Open [the immutable world archive](https://lastwords-eznzihexpa-du.a.run.app/remains#world-archive) to inspect completed numbered worlds.
